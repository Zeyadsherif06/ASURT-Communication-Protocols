...
// UART variables
uint8_t UART_received_data[1];
char UART_message[100];

// SPI variables
uint8_t SPI_Sent_data[8];
uint8_t SPI_Junk[8];
...
// Final readings
float final_temp;
float final_throttle_percent;
float final_voltage_level;
int final_wheel_speed;
uint8_t Encoded_Readings[8];
